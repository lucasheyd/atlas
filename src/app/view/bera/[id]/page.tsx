...
import { getNFTDetails } from '@/utils/beraContract';

// Define the type for the NFT details 
type NFTDetails = {
  id: string;
  name: string;
  description?: string;
...
export default function ViewBeraNFTPage({ params }: ViewNFTPageProps) {
  // Directly extract tokenId from params
  ...
  useEffect(() => {
    const fetchNFTDetails = async () => {
      ...
      try {
        ...
        console.log('Fetched Bera NFT Details:', details);
        setNftDetails(details);
      } catch (error) {
        console.error('Error fetching Bera NFT details:', error);
        setNftDetails(null);
      } finally {
        setLoading(false);
      }
